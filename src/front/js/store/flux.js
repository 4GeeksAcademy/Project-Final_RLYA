	...
	return {
		...
		actions: {
			...
			login: async (email, password) => {
				...
				try {
					let data = await axios.post("https://potential-waddle-g4qq5r4qxw9r3w7w5-3001.app.github.dev/api/login", {
						"email": email,
						"password": password
					})
					console.log(data);
			...
			ValidToken: async () => {
				try {
					...
					const response = await axios.get(`https://potential-waddle-g4qq5r4qxw9r3w7w5-3001.app.github.dev/api/validToken`, {
