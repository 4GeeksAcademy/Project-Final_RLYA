    ...
    return (
        ...
        <div className="PadreInicio  d-flex flex-column" >
            <div className="PadreBorroso" >
                ...
                <div className="margen-superior container" style={{ marginTop: "200px" }}>
                    <div className="row">
                        <div className="col m-auto">
                            <div className="row d-flex flex-row justify-content-around">
                                <div className="col-md-2 d-flex align-items-center justify-content-center">
                                    <div className="card p-3 text-center text-warning h-100 " >
                ...
                <div className="bg-dark w-100 align-self-center shadow-lg d-flex flex-column" style={{ padding: "50px", marginTop: "200px",marginBottom:"200px" }}>
                    <h3 className=" text-center text-light fw-bold">Nuestros Planes Mensuales</h3>
