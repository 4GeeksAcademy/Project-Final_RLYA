                    ...
                    <div className="row">
                        ...
                        <div className="row d-flex flex-row justify-content-around">
                            ...
                            store.planes? store.planes.map((plan,index)=> {
                                        return <div role="button" onClick={()=>setSelectedPlan(plan)} key={index + "index"} className={`col-3 d-flex flex-column align-items-center justify-content-center p-3 rounded border border-3 ${selectedPlan === plan ? "border-success" : "border-secondary"}`}>
